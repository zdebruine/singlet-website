...
const FIXTURE: Fixture[] = [
  ...
  { id: "GSE300001", title: "Tumor-infiltrating T cells in melanoma", abstract: "Melanoma biopsies with sorted T cells.", organisms: HUMAN, tissue_groups: ["Tumor (site unspecified)"], n_total: 9,
    filters: [{ field: "cell_type", value: "t cell", n_samples: 9 }] },
  { id: "GSE300002", title: "Melanoma microenvironment", organisms: HUMAN, tissue_groups: ["Skin"], disease_groups: ["Cancer"], n_total: 7, filters: [{ field: "cell_type", value: "t cell", n_samples: 3 }] },
