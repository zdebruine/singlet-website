...
const AtlasDocs = () => {
  ...
  const totalSamples = stats?.total_samples?.toLocaleString() ?? "3,251+";
  const successSamples = stats?.success_samples?.toLocaleString() ?? "1,390+";
...
# → singlet_stats → "3,251 samples (1,390 SUCCESS), 4.0M cells, 8 species"
