...
const AtlasDocs = () => {
  ...
  const totalSamples = stats?.total_samples?.toLocaleString() ?? "3,099+";
  const successSamples = stats?.success_samples?.toLocaleString() ?? "1,318+";
...
# → singlet_stats → "3,099 samples (1,318 SUCCESS), 3.7M cells, 16 species"
