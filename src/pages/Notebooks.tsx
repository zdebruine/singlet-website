...
const NOTEBOOKS: Notebook[] = [
  // ── Ready (executed, committed) ──────────────────────────────────
  {
    ...
    description:
      "Browse the 2,407-sample catalog, filter by species/status/quality, explore datasets and series — all with the singlet-bio Python package.",
