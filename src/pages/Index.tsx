    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-[0.95] tracking-tightest mb-5">
            We learned the transcriptional<br />
            <span className="gradient-text">grammar of every human cell.</span>
          </h1>
          ...
          <p className="text-xs text-muted-foreground/50 mt-5 font-mono tracking-wide">
            pip install singletai · Open source · Permissive licensing
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <a href="mailto:hello@singletdb.com?subject=Singlet%20AI%20Enterprise" className="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-md border border-border bg-secondary text-secondary-foreground text-sm font-medium hover:bg-muted transition-colors">Contact Sales</a>
            </div>
          </div>
        </div>
      </section>
