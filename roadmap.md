...
- [x] Relax full-match status semantics while preserving score fractions and evidence
- [x] Compute conditional rail counts/totals from the ranked candidate set
- [x] Standardize ordered hit/partial/miss evidence chips, MCP match data and why text
- [x] Use bundle sample counts consistently, with explicit catalog fallback labels
- [x] Show interpretation loading state and keyword fallback after 800 ms
